...
interface CardsProps {
  ...
  return (
    <div className='bg-darkBlue border-4 border-techGreen p-2 shadow-[10px_10px_#64ffda] flex flex-col md:flex-row transition ease-in-out duration-200 xl:hover:-translate-y-4 md:hover:translate-y-[-8px] md:hover:translate-x-[-8px] md:hover:shadow-[18px_18px_#64ffda]'>
