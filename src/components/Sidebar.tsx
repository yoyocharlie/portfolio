...
const Sidebar: React.FC<Sidebar> = ({showSidebar, setShowSidebar}) => {
  ...
  return (
    <div className={showSidebar ? visibility : `${visibility} -right-full`}>
        ...
        <Link className="bg-techGreen border border-techGreen text-darkBlue rounded-md text-xl p-3 mb-5 flex items-center gap-5 mx-4 hover:cursor-pointer hover:bg-darkBlue hover:text-techGreen mt-8 transition duration-200 ease-out hover:ease-in" href={''}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-5">
