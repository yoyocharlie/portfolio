    ...
    <div id='about' className='w-full pb-10 relative bg-lessDarkBlue flex flex-col items-center overflow-hidden'>
      ...
      <div className='flex flex-col max-w-[350px] md:max-w-[1430px] lg:grid xl:grid-cols-2 gap-10 mx-5 md:mx-20 md:mt-40'>
        <div className='flex flex-col'>
          <p className='font-paraText text-techGrey text-sm md:max-w-[700px] md:text-lg lg:text-xl'>As a recent graduate of the <Link target={"_blank"} className='text-techGreen underline' href={'https://codex.academy/'}>CodeX Academy</Link> bootcamp, I am a highly motivated and dedicated individual with a passion for coding and a desire to constantly improve my skills. I have experience with programming technologies such as JavaScript, TypeScript, HTML, and SCSS, as well as frameworks such as React.js, <Link target={"_blank"} className='text-techGreen underline' href={'https://create.t3.gg/'}>T3 Stack</Link>, and more:</p>
